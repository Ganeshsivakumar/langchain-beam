...
BASE_GCS_URL="https://storage.googleapis.com/langbeam-cloud/build/flink-templates/llm-batch-process"

# Construct JAR URL based on version
JAR_URL="${JAR_URL:-$BASE_GCS_URL/llm-batch-process-flink-${FLINK_VERSION}.jar}"

# Download location for the JAR
JAR_PATH="/tmp/llm-batch-processor.jar"
